...
|------|-------|----------|---------------|
| **Patient** | patient@email.com | demo123 | /dashboard |
| **Doctor** | dr.emily.watson@doktorabc.com | demo123 | /doctor/dashboard |
| **Pharmacy** | central.pharmacy@partner.com | demo123 | /pharmacy/dashboard |
| **Support** | support@doktorabc.com | demo123 | /support/dashboard |
| **Customer Service** | cs@doktorabc.com | demo123 | /customer-service/dashboard |
...
### Doctor 2
**Email:** `dr.james.chen@doktorabc.com`  
**Password:** `demo123`

### Pharmacy 2
**Email:** `manchester.pharmacy@partner.com`  
**Password:** `demo123`
